...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        //ContactsContract.Intents.Insert ContentValues into database and get a row ID back
        long locationId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, testValues);
        assertNotNull(locationId);
        assertTrue(locationId != -1);

        //DownloadManager.Query the database and receive a Cursor back
    ...
    public void testWeatherTable() {
        ...
        Long locationId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, locationValues);
        assertTrue(locationId != -1);
        ...
        TestUtilities.validateCursor("Error", weatherCursor, weatherValues);
